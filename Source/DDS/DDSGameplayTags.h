...
namespace DDSGameplayTags
{
	...
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Sprint)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Walk)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Crouch)
	...
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attribute_Offense_BaseAttack)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attribute_Offense_BaseAttackPlus)
	...
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attribute_Offense_PhysicalASR)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attribute_Offense_DexterityASR)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attribute_Offense_MagicASR)
	
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attribute_Weapon_AttackRequireStamina);
	...
	/** Player Tags */
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Move)
	...
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_State_BlockMove)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_State_Moving)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_State_Sprinting)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_State_Walking)
	...
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_BaseATK)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_BaseATKPlus)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_PowASR)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_PowASRPlus)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_DexASR)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_DexASRPlus)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_MgcASR)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_MgcASRPlus)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_UseSTA)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_AttackSpeed)
	DDS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SetByCaller_StanceATK)
